...
const pods = {
  ...
  DESCRIPTION_HTML: '<div class="description"><div class="desc">All Points of Dispensing sites may not be activated at the time of an incident. Please continue checking this page to see which sites are activated following an event. If you do not live in NYC, please check with your local health department.<br><br>Click on the NYC Health Logo to refresh the map.</div></div>',

...
const pods = {
  ...
  DESCRIPTION_HTML: '<div class="description"><div class="desc">Not all Points of Dispensing sites may be activated at the time of an event. Please continue checking this page to see which sites are activated following an event. If you do not live in NYC, please check with your local health department.</div></div>',
